document.getElementById("messageForm").addEventListener("submit", function (event) {
  ...
  formData.append("recipientID", recipientID); // Ensure recipientID is set correctly
  ...
  // Set up the request
  xhr.open("POST", "http://127.0.0.1/paract/Flight-System-Website/backend/message.php", true);
  ...
  xhr.onload = function () {
    if (xhr.status === 200) {
      ...
      console.log(recipientID); // Ensure recipientID is correct here
